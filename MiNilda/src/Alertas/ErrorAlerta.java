 ...
 */
public class ErrorAlerta extends javax.swing.JDialog {

     Timer timer = null;
    TimerTask task;
    int i = 32;
    public ErrorAlerta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 0, 0), 5));
        ...
        lblMensaje2.setText("¡¡¡COMPLETE TODOS LOS CAMPOS!!!");
        ...
        lblMensaje1.setText("¡¡¡ERROR!!!");

        rSButtonRiple1.setBackground(new java.awt.Color(255, 255, 255));
        rSButtonRiple1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 0, 0), 10));
        rSButtonRiple1.setText("ACPETAR");
        rSButtonRiple1.setColorHover(new java.awt.Color(255, 255, 255));
        rSButtonRiple1.setColorText(new java.awt.Color(200, 0, 0));
        rSButtonRiple1.setColorTextHover(new java.awt.Color(200, 0, 0));
  ...
  task = new TimerTask() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorAlerta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorAlerta dialog = new ErrorAlerta(new javax.swing.JFrame(), true);
