 ...
 */
public class WarningAlertaSalir extends javax.swing.JDialog {
    ...
    public WarningAlertaSalir(FormMenuPrincipal principal, boolean modal) {
    ...
    private void initComponents() {
        ...
        lblMensaje2.setText("¡¡¡DE CERRAR SESION!!!");
        ...
        lblMensaje1.setText("¡¡¡ESTA SEGURO!!!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertaSalir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertaSalir dialog = new WarningAlertaSalir((FormMenuPrincipal) new javax.swing.JFrame(), true);
