 ...
 */
public class WarningAlertaCL extends javax.swing.JDialog {

    Timer timer = null;
    TimerTask task;
    int i = 32;
    clienteController cc = new clienteController();
    modalCliente idCli = (modalCliente) Memoria.get("idCli");

    public WarningAlertaCL(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertaCL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertaCL dialog = new WarningAlertaCL(new javax.swing.JFrame(), true);
