...
public class CategoriaView extends javax.swing.JInternalFrame {
    ...
    public CategoriaView() {
        initComponents();
        //this.setUI(null);
        tblCategorias.getTableHeader().setDefaultRenderer(new util.EstiloTablaHeader());
        tblCategorias.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
            tblCategorias.setDefaultRenderer(Object.class, new util.EstiloTablaRendererCenter());
        ...
        cc.ListarCategoria(tblCategorias, "");
    ...
    private void initComponents() {
        ...
        setTitle("Categorias");
        setToolTipText("");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_bulleted_list_48px.png"))); // NOI18N
        ...
        tblCategorias.setGridColor(new java.awt.Color(0, 0, 0));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        if (tblCategorias.getSelectedRow() > -1) {
            tblCategorias.removeRowSelectionInterval(tblCategorias.getSelectedRow(), tblCategorias.getSelectedRow());
        }
        Memoria.put("accionC", categoriaController.CRUD_NUEVO);
        accionesCategoria view = new accionesCategoria(null, true);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (tblCategorias.getRowCount() > 0) {
            if (tblCategorias.getSelectedRowCount() > 0) {
                ...
                modalCategoria idcat = new modalCategoria();
                int codigo = (int) tblCategorias.getValueAt(tblCategorias.getSelectedRow(), 0);
                idcat.setIdCategoria(codigo);

                Memoria.put("idCat", idcat);
                WarningAlertaC wa = new WarningAlertaC(null, true);
                wa.setVisible(true);
                cc.ListarCategoria(tblCategorias, "");
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (tblCategorias.getRowCount() > 0) {
            if (tblCategorias.getSelectedRowCount() > 0) {
                int idUsuario = (int) tblCategorias.getValueAt(tblCategorias.getSelectedRow(), 0);
                String categoria = (String) tblCategorias.getValueAt(tblCategorias.getSelectedRow(), 1);
                String descripcion = (String) tblCategorias.getValueAt(tblCategorias.getSelectedRow(), 2);

                modalCategoria mc = new modalCategoria(idUsuario, categoria, descripcion);
//
                Memoria.put("accionC", categoriaController.CRUD_EDITAR);
                Memoria.put("categoria", mc);
                accionesCategoria view = new accionesCategoria(null, true);
    ...
    private void txtbuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarKeyReleased
        ...
        cc.ListarCategoria(tblCategorias, busca);
