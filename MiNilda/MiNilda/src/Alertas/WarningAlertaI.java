 ...
 */
public class WarningAlertaI extends javax.swing.JDialog {

    Timer timer = null;
    TimerTask task;
    int i = 32;
    inventarioController ic = new inventarioController();
    modalInventario idInv = (modalInventario) Memoria.get("idInv");

    public WarningAlertaI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void rSButtonRiple1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonRiple1ActionPerformed
        ...
        if (ic.sql_deleteInventario(idInv)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertaI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertaI dialog = new WarningAlertaI(new javax.swing.JFrame(), true);
