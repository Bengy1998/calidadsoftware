 ...
 */
public class WarningAlertaU extends javax.swing.JDialog {
    ...
    modalUnidad idUni = (modalUnidad) Memoria.get("idUni");

    public WarningAlertaU(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertaU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertaU dialog = new WarningAlertaU(new javax.swing.JFrame(), true);
